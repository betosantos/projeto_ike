            ...
            <div class="panel-heading">
                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-md-10">                    
                           <h2><p>Atualizar Reclamação </p></h2>
                        </div>                        
                    </div>
                </div>
            </div>
            
        <form action="<?php echo base_url(); ?>reclamacao/salvar_atualizacao" method="post">
        <input type="hidden" id="id" name="id" value="<?php echo $reclamacao[0]->id; ?>">
            
          <div class="row">      
                    <div class="col-md-2">    
                        <div class="form-group">
                            <label for="nome">Mês/Ano</label>
                            <input type="text" class="form-control datepicker" id="mes" name="mes" value="<?php echo $reclamacao[0]->mes; ?>">
                        </div>
                    </div>  
                    ...
                    <div class="col-md-7">    
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="enviado" name="enviado" placeholder="Enviado Por" value="<?php echo $reclamacao[0]->enviado; ?>">
                        </div>
                    </div>   
                </div> <!-- fim row -->
                ...
                <div class="row">    
                    <div class="col-md-6">    
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Reclamante" id="reclamante" name="reclamante" value="<?php echo $reclamacao[0]->reclamante; ?>">
                        </div>
                    </div>  
                    ...
                    <div class="col-md-2">    
                        <div class="form-group">
                            ...
                            <select id="genero" class="form-control" name="genero" value="<?php echo $reclamacao[0]->genero; ?>">
                                <option value="0">Selecione</option>
                ...
                <div class="row">
                    <div class="col-md-4">    
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" id="data_atend" name="data_atend" placeholder="Data de Atendimento" value="<?php echo $reclamacao[0]->data_atend ?>">
                        </div>
                    </div>    
                    ...
                    <div class="col-md-4">    
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="sise" name="sise" placeholder="SISE" value="<?php echo $reclamacao[0]->sise; ?>">
                        </div>
                    </div>                           
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">    
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="cidade" name="cidade" value="<?php echo $reclamacao[0]->cidade; ?>">
                        </div>
                    </div>                           
                </div> <!--- FIM ROW -->                 
                ...
                <div class="row">
                    <div class="col-md-12">    
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="agente" name="agente" placeholder="Nome do Agente" value="<?php echo $reclamacao[0]->agente; ?>">
                        </div>
                    </div>                            
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">    
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" id="responsavel" name="responsavel" placeholder="Responsável" value="<?php echo $reclamacao[0]->responsavel; ?>">
                        </div>
                    </div>                    
                </div> <!--- FIM ROW -->         
                ...
                <div class="row"> 
                    <div class="col-md-6">    
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" id="acao" name="acao" placeholder="Ação do Departamento" value="<?php echo $reclamacao[0]->acao; ?>">
                        </div>
                    </div>    
                    ...
                    <div class="col-md-6">    
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" id="comentario" name="comentario" placeholder="Comentáio" value="<?php echo $reclamacao[0]->comentario; ?>">
                        </div>
                    </div>  
                </div>
